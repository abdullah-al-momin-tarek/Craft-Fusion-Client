...
const Unique = () => {
    return (
        <section className='flex flex-col md:flex-row justify-center mt-10 p-5 gap-5 items-center'>
            <div className=''>
            ...
            <div className='flex flex-col   ml-0 md:-ml-28'>
                ...
                <div className='flex'>
                    ...
                    <div className='w-96'>
                        <img className='rounded-b-full bg-white' src="/public/Home/artcraft.jpg" alt="" />
                    </div>
                </div>
            </div>
        </section>
